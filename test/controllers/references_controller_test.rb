...
class ReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post references_url, params: { reference: { excerpt: @reference.excerpt, genre_id: @reference.genre_id, line: @reference.line, name: @reference.name, page: @reference.page, work_id: @reference.work_id } }
    end
  ...
  test "should update reference" do
    patch reference_url(@reference), params: { reference: { excerpt: @reference.excerpt, genre_id: @reference.genre_id, line: @reference.line, name: @reference.name, page: @reference.page, work_id: @reference.work_id } }
