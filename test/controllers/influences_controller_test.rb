...
class InfluencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create influence" do
    assert_difference('Influence.count') do
      post influences_url, params: { influence: { author: @influence.author, period: @influence.period, pubdate: @influence.pubdate, title: @influence.title } }
    end
  ...
  test "should update influence" do
    patch influence_url(@influence), params: { influence: { author: @influence.author, period: @influence.period, pubdate: @influence.pubdate, title: @influence.title } }
